...
class Lists extends CI_Controller {
	...
	//	echo $setData['page'];
		...
		if( !empty($setData['session']['where']['id']) || !empty($setData['session']['where']['title_'.$setData['lang']])  || $setData['session']['status']>=0 ):
	...
	function showTable($value){
		...
		$data['template'] 		  = "admin/ListArticle/".$value['action'].".php";		

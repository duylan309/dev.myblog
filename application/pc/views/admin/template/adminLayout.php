...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<?=asset_url()?>js/admin/adjava.js"></script>
		<script type="text/javascript" src="<?=asset_url()?>js/thue.min.js"></script>
		...
		function setTextEditor($ID){
			tinymce.init({
				...
				toolbar: 'undo redo | styleselect | bold italic underline | forecolor backcolor fontsizeselect | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media code | fullscreen',
				link_class_list: [
				   {title: 'None', value: ''},
		...
		$(document).ready(function(){
			...
			$('.menu-left-admin').find('li.selected').closest('ul').addClass('in');

<form class="form-horizontal" action="<?=base_url().ADMINBASE?>?page=<?=$page?>&action=savephoto&id=0&function=Item" method="post" id="submitForm" enctype="multipart/form-data">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a class="btn btn-default pull-right btn-sm m-r-15" href="<?=base_url().ADMINBASE?>?page=<?=$page?>&action=gallery&id=0&function=photo">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <i class="fa fa-table"></i> <a href="<?=base_url().ADMINBASE?>?page=<?=$page?>&action=gallery&id=0&function=photo"><?=$result->name?> </a>
        </li>
      </ol>
    </div>
  </div>

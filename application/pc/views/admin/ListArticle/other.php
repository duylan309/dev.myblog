            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td class="t1" colspan="2">
                  ...
                  <?php if(isset($listArticleChoose) && count($listArticleChoose) && $listArticleChoose && !getParam($this,'page') ):?>
                              ...
                              <td><img class="otherimg" src="<?=base_url()?>upload/<?=$page?>/<?=$articlechoose->image?>" /></td>
                          ...
                          <td><img class="otherimg" src="<?=base_url()?>upload/<?=$page?>/<?=$article->image?>" /></td>

   ...
   <div class="subhead">
    <ul>
      <li style="float:left"> <a href="#" class="btn clearmenu">
        <h2 style="color:#fff;font-size:10pt;margin-left:20px"><?=$lang=="en" ? $getMenuAdmin->title_en:$getMenuAdmin->title_vn?>&nbsp;&nbsp;&nbsp; -&nbsp;&nbsp;&nbsp;</h2>
        </a> </li>
  ...
  <div class="listContent">
    ...
    <table width="100%"  cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse" bordercolor="#D6D6D6" class="listItem">
      <thead>
        <tr class="thead">
          ...
          <td class="colStatus" ><?=$language->STATUS?>
            </td>
        </tr>
      </thead>
      <tr class="tSearch">
	...
	?>
        <tr id="<?=$row->id?>">
          ...
          <td class="col6"><span>
            <input class="changesort" value="<?=$row->sort?>" page="<?=$page?>" onchange="changeSort(<?=$row->id?>,'<?=$page?>','<?=base_url()?>',<?=$row->cat?>,0)" />
            </span>
            </label></td>

	...
	$.fn.extend({ 
		infiniteCarousel: function(options)
		{
			...
			var options = $.extend(defaults, options);
				...
				$(obj).append('<div class="ic_left_nav" style="position:absolute;left:0;width:40px;top:'+(heightSource/2-24)+'px;">').append('<div class="ic_right_nav" style="position:absolute;width:40px;right:0;top:'+(heightSource/2-24)+'px;">');
